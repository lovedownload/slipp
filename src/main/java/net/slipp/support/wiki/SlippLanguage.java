...
public class SlippLanguage extends AbstractMarkupLanguage {
    ...
    public SlippLanguage(SocialUserService socialUserService) {
    ...
    protected void addStandardBlocks(List<Block> blocks, List<Block> paragraphBreakingBlocks) {
        // IMPORTANT NOTE: Most items below have order dependencies. DO NOT
        // REORDER ITEMS BELOW!!
    ...
    protected void addStandardTokens(PatternBasedSyntax tokenSyntax) {
        ...
        tokenSyntax.add(new EscapedCharacterReplacementToken()); // ORDER
                                                                 // DEPENDENCY
                                                                 // must come
                                                                 // after line
                                                                 // break
        ...
        tokenSyntax.add(new MentionReplacementToken(socialUserService));
    }
